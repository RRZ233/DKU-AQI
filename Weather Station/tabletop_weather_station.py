#This file comes from https://github.com/Tinkerforge/tabletop-weather-station/blob/master/examples/python/tabletop_weather_station.py
#!/usr/bin/env python
# -*- coding: utf-8 -*-
...
class WeatherStation:
    ...
    def cb_all_values(self, iaq_index, iaq_index_accuracy, temperature, humidity, air_pressure):
        if self.lcd is not None:
            ...
            # print(f"IAQ Index: {iaq_index}, Accuracy: {iaq_index_accuracy}")
            # print(f"Temperature: {temperature / 100.0} °C")
            # print(f"Humidity: {humidity / 100.0} %RH")
            # print(f"Air Pressure: {air_pressure / 100.0} hPa")
